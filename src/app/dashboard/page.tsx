                ...
                {studioCategories.map((studio) => {
                  ...
                  return (
                    <div key={studio.id} className="glass-card rounded-xl border border-outline hover:border-primary/50 hover:shadow-ambient-soft transition-all group overflow-hidden relative z-0">
                      <Link href={studio.id === 'DOC2LATEX' ? '/upload' : studio.id === 'LATEX_STUDIO' ? '/latex-studio/projects' : studio.id === 'DIAGRAM' ? '/diagrams/editor' : studio.id === 'MIGRATOR' ? '/template-migrator/studio' : studio.id === 'REVIEWER' ? '/reviewer/studio' : studio.id === 'CITATIONS' ? '/citations/studio' : '#'} className="block p-md border-b border-outline bg-surface/40 relative z-10 hover:bg-surface-container-low transition-colors">
