                ...
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative group">
                            ...
                            {/* Theme Menu Dropdown */}
                            {isThemeMenuOpen && (
                                <div className="absolute right-0 mt-2 w-48 max-h-[50vh] overflow-y-auto rounded-xl border shadow-xl z-50 animate-in fade-in slide-in-from-top-2 custom-scrollbar" style={{ backgroundColor: "var(--color-admin-surface-container-high)", borderColor: "var(--color-admin-outline-variant)" }}>
