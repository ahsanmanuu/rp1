  ...
  try {
    ...
    if (bannerCount === 0) {
      const defaultBanners = [
        ...
        { title: 'AI Peer Reviewer', subtitle: 'Get instant, scholarly feedback on clarity, argumentation, and methodology.', imageUrl: '/images/hero_ai_reviewer_1775979312099.png', linkUrl: '/reviewer', isActive: true, sortOrder: 2 },
