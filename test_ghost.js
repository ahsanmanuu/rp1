...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var mainTex, imgB64, files, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, compiler_engine_server_1.runHardenedPipeline)('pdflatex', files, 'main.tex', 'test_proj', { profile: 'doc2latex', ghostMode: true })];
                case 1:
                    result = _a.sent();
                    ...
                    if (result.pdfBase64) {
                        fs_1.default.writeFileSync('test_out.pdf', Buffer.from(result.pdfBase64, 'base64'));
